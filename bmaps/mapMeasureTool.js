...
//function mapService($http,$rootScope){
	...
	function init(_map,_epsg,_viewProjection,_vectorSource,_vectorLayer,_token,_app_name,_geom_colors,_touchDevice,localized_strings){
		...
		if(typeof localized_strings.CLICK_TO_CONTINUE_MEASURING!="undefined" && localized_strings.CLICK_TO_CONTINUE_MEASURING!="undefined"){
		...
		if(typeof localized_strings.CLICK_TO_START_MEASURING!="undefined" && localized_strings.CLICK_TO_START_MEASURING!="undefined"){
